...
import { Blog, EmployeeResponse } from '@/context/types'
...
import TableHeader from '@/views/apps/blog/TableHeader'
import { Box, Card, CardHeader, Divider, Grid, IconButton, Menu, MenuItem, SelectChangeEvent, Typography, styled } from '@mui/material'
...
const BlogList = () => {
    ...
    const columns: GridColDef[] = [
        ...
        },
        {
            ...
            field: 'actions',
            headerName: 'Actions',
            renderCell: ({ row }: CellType) => <RowOptions id={row.blogcd} />
        }
    ]
